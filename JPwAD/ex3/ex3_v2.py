...
corr = absenteeism_df_without_target.corr().abs()
...
print(absenteeism_df.corr().abs().unstack().sort_values().drop_duplicates()[0])


reduced_absence_df = absenteeism_df[['Absenteeism time in hours', 'Disciplinary failure', 'Service time']]
...
chi2_df.columns = ['Reason', 'Transportation expense']
